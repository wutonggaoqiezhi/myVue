...
export default class AudioManager {
    ...
    transFadeIn: TWEEN.Tween;
    transFadeOut: TWEEN.Tween;
    ...
    constructor( app: WuHouCiApp ) {
        ...
        this.transFadeIn = new TWEEN.Tween(this.source.gain.gain)
            .to({ value: 1 }, 1000)
            .onStart(()=>{ this.source.play() })
        
        this.transFadeOut = new TWEEN.Tween(this.source.gain.gain)
            .to({ value: 0 }, 1000)
            .onComplete(()=>{ this.source.pause() })
    ...
    init() {
        ...
        this.resources.set(FlowEnum.WenChenLang, `audio/hotspot/WenChenLang/${this.app.lang || 'zh'}.mp3`);   //文臣廊
        this.resources.set(FlowEnum.WuJiangLang, `audio/hotspot/WenChenLang/${this.app.lang || 'zh'}.mp3`);   //武将廊
        this.resources.set(FlowEnum.HanZhaoLieMiao, `audio/hotspot/LiuBeiDian/${this.app.lang || 'zh'}.mp3`); //刘备殿
    ...
    {
        let resource = this.resources.get(flow);  
