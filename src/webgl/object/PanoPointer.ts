...
export default class PanoPointer extends THREE.Mesh {
    ...
    textureBasic: THREE.Texture;
    textureNormal: THREE.Texture;
    textureActive: THREE.Texture;
    ...
    buildTextures() {
        ...
        this.textureBasic = new THREE.Texture();
        this.textureBasic.image = new Image();
        this.textureBasic.image.src = "image/reticule.png";
        this.textureBasic.image.onload = () => { this.textureBasic.needsUpdate = true };

        this.textureNormal = new THREE.Texture();
        this.textureNormal.image = new Image();
        this.textureNormal.image.src = "image/pointBasic.png";
        this.textureNormal.image.onload = () => { this.textureBasic.needsUpdate = true };

        this.textureActive = new THREE.Texture();
        this.textureActive.image = new Image();
        this.textureActive.image.src = "image/pointActive.png";
        this.textureActive.image.onload = () => { this.textureBasic.needsUpdate = true };
