<template>
    <div class="sanguo-map">
        ...
        <div class="map-container">
            <div class="map">
                <img src="addition/SanguoMap/total.png" height="100%"/>
                <img class="patial wei" :class="{'active': selectedIndex == 0 }" src="addition/SanguoMap/wei.png" height="100%" @mouseenter="onMouseEnter(0)" @mouseleave="onMouseOut()"/>
                <img class="patial shu" :class="{'active': selectedIndex == 1 }" src="addition/SanguoMap/shu.png" height="100%" @mouseenter="onMouseEnter(1)" @mouseleave="onMouseOut()"/>
                <img class="patial wu" :class="{'active': selectedIndex == 2 }" src="addition/SanguoMap/wu.png" height="100%" @mouseenter="onMouseEnter(2)" @mouseleave="onMouseOut()"/>          
            </div>
            <div class="info">
                <div class="lines">
